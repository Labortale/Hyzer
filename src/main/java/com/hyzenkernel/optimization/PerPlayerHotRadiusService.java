...
public class PerPlayerHotRadiusService {
    ...
    private final HyzenKernelConfig.PerPlayerRadiusConfig config;
    ...
    public PerPlayerHotRadiusService(@Nonnull HytaleLogger logger, @Nonnull HyzenKernelConfig.PerPlayerRadiusConfig config) {
